...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": int(os.getenv("PAGE_SIZE", "99") or "99"),
}
...
DJOSER = {
    ...
    "EMAIL": {
        ...
        "send_email_new_post_created": "core.email.SendEmailNewPostCreated",
    },
    "SERIALIZERS": {
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(weeks=1) if DEBUG else timedelta(minutes=60),
