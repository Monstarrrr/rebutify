  ...
  return {
    ...
    c: [
      ...
      },
      {
        ...
        b: ':',
        e: ';',
        c: [r, i, o, e.CSSNM, e.QSM, e.ASM, { cN: 'important', b: '!important' }],
      },
      {
        cN: 'at_rule',
        b: '@',
...
hljs.registerLanguage('ruleslanguage', function (T) {
  return {
    ...
    c: [T.CLCM, T.CBCM, T.ASM, T.QSM, T.CNM, { cN: 'array', b: '#[a-zA-Z .]+' }],
  }
})
...
hljs.registerLanguage('scilab', function (e) {
  var n = [e.CNM, { cN: 'string', b: '\'|"', e: '\'|"', c: [e.BE, { b: "''" }] }]
  return {
    aliases: ['sci'],
    k: {
      keyword:
...
hljs.registerLanguage('rsl', function (e) {
  return {
    ...
    c: [
      ...
      e.CNM,
      { cN: 'preprocessor', b: '#', e: '$' },
      { cN: 'shader', bK: 'surface displacement light volume imager', e: '\\(' },
  ...
  return {
    ...
    c: [
      ...
      { cN: 'preprocessor', b: '#', e: '$', k: 'if else elseif end error' },
      {
        ...
        c: [
          e.TM,
          { cN: 'params', b: '\\(', e: '\\)', c: [e.ASM, e.QSM, e.CLCM, e.CBCM] },
          { cN: 'type', b: ':', e: r, r: 10 },
        ],
      },
    ],
      ...
      { cN: 'type', b: /</, e: />/, rB: !0, eE: !1, r: 0 },
      {
        ...
        c: [
          ...
          { cN: 'type', b: /</, e: />/, k: 'reified', r: 0 },
          {
            ...
            i: /\([^\(,\s:]+,/,
            c: [
              { cN: 'typename', b: /:\s*/, e: /\s*[=\)]/, eB: !0, rE: !0, r: 0 },
            ],
          },
          e.CLCM,
          e.CBCM,
...
hljs.registerLanguage('nimrod', function (t) {
  return {
    ...
    c: [
      ...
      { cN: 'number', b: /\b(0(b|B)[01][_01]*)('?[iIuUfF](8|16|32|64))?/, r: 0 },
          ...
          c: [
            {
              ...
              b: t,
              r: 0,
              starts: { cN: 'markup', e: '\\[noprocess\\]|' + a, rE: !0, c: [n] },
            },
            o,
            i,
          ].concat(c),
