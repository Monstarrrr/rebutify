      ...
      5: [
        function (require, module, exports) {
          ...
          function lookupLink(node, keys) {
            ...
            try {
              for (
                var _iterator = keys[Symbol.iterator](), _step;
                ...
                if (node === undefined) {
                  throw new errors.LinkLookupError(
                    'Invalid link lookup: ' + JSON.stringify(keys),
                  )
                }
              }
            } catch (err) {
          ...
          var Client = (function () {
            function Client() {
              ...
              this.decoders = options.decoders || [
                new codecs.CoreJSONCodec(),
                new codecs.JSONCodec(),
                new codecs.TextCodec(),
              ]
              this.transports = options.transports || [
                new transports.HTTPTransport(transportOptions),
              ]
            }
            ...
            _createClass(Client, [
              {
                ...
                value: function action(document, keys) {
                  ...
                  var transport = utils.determineTransport(
                    this.transports,
                    link.url,
                  )
          ...
          var ParameterError = (function (_Error) {
            ...
            function ParameterError(message) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  ParameterError.__proto__ ||
                  Object.getPrototypeOf(ParameterError)
                ).call(this, message),
              )
          ...
          var LinkLookupError = (function (_Error2) {
            ...
            function LinkLookupError(message) {
              ...
              var _this2 = _possibleConstructorReturn(
                this,
                (
                  LinkLookupError.__proto__ ||
                  Object.getPrototypeOf(LinkLookupError)
                ).call(this, message),
              )
          ...
          var ErrorMessage = (function (_Error3) {
            ...
            function ErrorMessage(message, content) {
              ...
              var _this3 = _possibleConstructorReturn(
                this,
                (
                  ErrorMessage.__proto__ || Object.getPrototypeOf(ErrorMessage)
                ).call(this, message),
              )
            ...
            _createClass(HTTPTransport, [
              ...
              },
              {
                ...
                value: function action(link, decoders) {
                  ...
                  return this.fetch(request.url, request.options).then(
                    function (response) {
      ...
      15: [
        function (require, module, exports) {
          ...
          var determineTransport = function determineTransport(transports, url) {
            ...
            try {
              for (
                var _iterator = transports[Symbol.iterator](), _step;
                !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                _iteratorNormalCompletion = true
              ) {
          ...
          var negotiateDecoder = function negotiateDecoder(
            decoders,
            contentType,
          ) {
            ...
            try {
              for (
                var _iterator2 = decoders[Symbol.iterator](), _step2;
            ...
            throw Error(
              'Unsupported media in Content-Type header: ' + contentType,
            )
          }
        ...
        function (require, module, exports) {
          ;(function (root, factory) {
            ...
            UrlTemplate.prototype.encodeValue = function (operator, value, key) {
              value =
                operator === '+' || operator === '#'
                  ? this.encodeReserved(value)
                  : this.encodeUnreserved(value)
             ...
             */
            UrlTemplate.prototype.getValues = function (
              context,
              operator,
              key,
              modifier,
                ...
                if (
                  ...
                  result.push(
                    this.encodeValue(
                      operator,
                      value,
                      this.isKeyOperator(operator) ? key : null,
                    ),
                  )
                } else {
                  if (modifier === '*') {
                    ...
                    if (Array.isArray(value)) {
                      ...
                      Object.keys(value).forEach(function (k) {
                        if (this.isDefined(value[k])) {
                          ...
                          tmp.push(
                            this.encodeValue(operator, value[k].toString()),
                          )
                        }
                      }, this)
                    }
                    ...
                    if (this.isKeyOperator(operator)) {
                      result.push(
                        this.encodeUnreserved(key) + '=' + tmp.join(','),
                      )
